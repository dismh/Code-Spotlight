...
export default function Home() {
  ...
  const iframeUrl =
    "https://dismh.github.io/code-spotlight-pages/three/index.html";
  const code = `<html>
<body>
<h1>MY SCHOOL LIFE 
<img src="school life of varnav and izan.jpg">
<h2>Hi i am varnav. i am in 6th grade. i love to study and play fortnite .
<h3>Hi i am izan. i am in 7th grade. i love to play cricket.
<img src="football bro.webp">
<img src="doon ground.webp",height =300,width=300>
    ...
    <>
      <main className="min-h-screen bg-black text-white px-4 py-5 flex flex-col items-center mt-20">
        <h1 className="text-4xl font-extrabold mt-5 mb-3 tracking-tight">
          Varnav's  School Days
        </h1>
        <p className="text-gray-400 mb-8 text-lg">
          A personal project  about varnav.
        </p>
